...
let backupDirPath = '/var/database/backup/';

const dbOptions = {
  user: 'bigbazar_backup',
  pass: 'Test10043!',
  host: 'localhost',
  port: 27017,
...
exports.dbAutoRestore = () => {
  ...
  if (dbOptions.autoBackup == true) {
    ...
    let newBackupPath = dbOptions.autoBackupPath + '-mongodump-' + newBackupDir + '/amanabigbazar';
    ...
    let cmd =
      'mongorestore --db '+dbOptions.database+' --verbose ' + newBackupPath;
