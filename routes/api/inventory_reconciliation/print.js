...
// @route GET api/inventory/reconciliation/print
// @description Get single inventory product reconciliation report pdf
// @access Private
router.post('/print', [
    auth,
    [
    ...
    try {
        ...
        let productDisposal = await InventoryProductReconciliation.findById(download_id).populate('admin', 'name').populate('branch', 'name address')
