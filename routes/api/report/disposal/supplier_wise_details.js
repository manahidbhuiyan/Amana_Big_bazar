...
// @route GET api/report/supplier/disposal/details?branch=..........
// @description Get disposal details report pdf
// @access Private
router.post('/supplier/disposal/details', adminAuth, async (req, res) => {
    try {
        ...
        const child = fork(path.join(__dirname, "subprocess", "supplier_wise_details.js"));
        ...
        child.on('message', async (response) => {
            ...
            var html = fs.readFileSync(path.join(__dirname, '..', '..', '..', '..', 'reports', 'disposal', 'supplier_wise_disposal_details.html'), 'utf8');
                ...
                header: {
                    ...
                    contents: {
                        ...
                        <tr>
                            ...
                            <th style="font-size: 10px; text-align: left; width: 27%;">Supplier Name</th>
            ...
            var document = {
                ...
                path: "./public/reports/supplier_wise_disposal_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/supplier_wise_disposal_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET api/report/supplier/disposal/details?branch=..........
// description Get supplier wise disposal details Excel report
// @access Private
router.get('/supplier/disposal/details/:adminID/:from/:to', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const specification = {
                ...
                supplierName: { // <- the key should match the actual data key
            ...
            const heading = [
                [{ value: 'Supplier Wise Disposal report from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Supplier Wise Disposal report from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('supplier_wise_disposal_report.xlsx'); // This is sails.js specific (in general you need to set headers)
