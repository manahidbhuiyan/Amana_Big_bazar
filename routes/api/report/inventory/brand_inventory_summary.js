...
// @route GET /api/report/brand/inventory/summery/report?branch=..........
// @description Get brand wise inventory report summery pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "inventory report summary by brand",
            ...
            var document = {
                ...
                path: "./public/reports/brand_inventory_report_summary.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/brand_inventory_report_summary.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /api/report/brand/inventroy/summary/report/:adminID/:brand?branch=..........
// @description Get brand wise inventroy report summary excel
// @access Private
router.get('/brand/inventory/summary/report/:adminID/:brand', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Brand wise Inventory Stock Summary On Date : ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Brand wise Inventory Stock Summary On Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('brand_wise_inventory_stock_summary.xlsx'); // This is sails.js specific (in general you need to set headers)
