...
// @route GET /api/report/category/inventory/summery/report?branch=..........
// @description Get category wise summery inventory report pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "inventory report summary by category",
            ...
            var document = {
                ...
                path: "./public/reports/category_inventory_report_summary.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/category_inventory_report_summary.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /api/report/category/inventory/summary/report/:adminID/:category?branch=..........
// @description Get category wise summary inventory report excel
// @access Private
router.get('/category/inventory/summary/report/:adminID/:category', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Category wise Inventory Stock Summary On Date : ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Category wise Inventory Stock Summary On Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('category_wise_inventory_stock_summary.xlsx'); // This is sails.js specific (in general you need to set headers)
