...
// @route GET /api/report/subcategory/inventory/details/report?branch=..........
// @description Get subcategory wise details inventory report pdf
// @access Private
router.post('/subcategory/inventory/details/report', [
    adminAuth,
    [
    ...
    try {
        ...
        const child = fork(path.join(__dirname, "subprocess", "subcategory_inventory_details.js"));
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "detail inventory report by subcategory",
                ...
                header: {
                    ...
                    contents: {
                        ...
                        <tr>
                            ...
                            <th style="font-size: 10px; text-align: left; width: 26%">Product Name</th>
                            <th style="font-size: 10px; text-align: right;">Quantity</th>
                            <th style="font-size: 10px; text-align: right;">Inv.Qty</th>
                            <th style="font-size: 10px; text-align: right;">C.Price</th>
                            <th style="font-size: 10px; text-align: right;">S.Price</th>
                            <th style="font-size: 10px; text-align: right;">Total CP</th>
                            <th style="font-size: 10px; text-align: right;">Total SP</th>
            ...
            var document = {
                ...
                path: "./public/reports/subcategory_inventory_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/subcategory_inventory_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /api/report/subcategory/inventory/details/report/:adminID/:subcategory?branch=..........
// @description Get subcategory wise details inventory report excel
// @access Private
router.get('/subcategory/inventory/details/report/:adminID/:subcategory', [
    [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'SubCategory wise Inventory Stock Details On Date : ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'SubCategory wise Inventory Stock Details On Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('subcategory_wise_inventory_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
