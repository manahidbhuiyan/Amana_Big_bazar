...
// @route GET /api/report/subcategory/inventory/summery/report/report?branch=..........
// @description Get subcategory wise summery inventory report pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "inventory report Summary by subcategory",
            ...
            var options = {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        class="table-border">
                        <tr>
                            <th style="font-size: 10px; text-align: left; width: 12% ;padding-left: 3px">Code</th>
            ...
            var document = {
                ...
                path: "./public/reports/subcategory_inventory_report_summary.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/subcategory_inventory_report_summary.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /api/report/subcategory/inventory/summary/report/:adminID/:subcategory?branch=..........
// @description Get subcategory wise summary inventory report excel
// @access Private
router.get('/subcategory/inventory/summary/report/:adminID/:subcategory', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'SubCategory wise Inventory Stock Summary On Date : ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'SubCategory wise Inventory Stock Summary On Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('subcategory_wise_inventory_stock_summary.xlsx'); // This is sails.js specific (in general you need to set headers)
