...
// @route GET /api/report/supplier/inventory/details/report/report?branch=..........
// @description Get supplier wise details inventory report pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "detail inventory report by supplier",
                ...
                header: {
                    ...
                    contents: {
                        ...
                        <tr>
                            ...
                            <th style="font-size: 10px; text-align: left; width: 27%">Product Name</th>
            ...
            var document = {
                ...
                path: "./public/reports/supplier_inventory_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/supplier_inventory_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /api/report/supplier/inventory/details/report/:adminID/:supplier?branch=..........
// @description Get supplier wise details inventory report excel
// @access Private
router.get('/supplier/inventory/details/report/:adminID/:supplier', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Supplier wise Inventory Stock Details On Date : ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Supplier wise Inventory Stock Details On Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('supplier_wise_inventory_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
