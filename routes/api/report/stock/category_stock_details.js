...
// @route GET /api/report/category/stock/details/report?branch=..........
// @description Get category wise details stock report pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        <tr>
                            ...
                            <th style="font-size: 10px; text-align: center;">Sales Amount</th>
            ...
            var document = {
                ...
                path: "./public/reports/category_stock_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/category_stock_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
router.get('/category/stock/details/:adminID/:category/:zero_stock', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Stock Details Report By Category At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Stock Details Report By Category At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('category_wise_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
