...
// @route GET /api/report/subcategory/stock/details/report?branch=..........
// @description Get subcategory wise details stock report pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var document = {
                ...
                path: "./public/reports/subcategory_stock_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/subcategory_stock_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
router.get('/subcategory/stock/details/:adminID/:subcategory/:zero_stock', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Stock Details Report By SubCategory At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Stock Details Report By SubCategory At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('subcategory_wise_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
