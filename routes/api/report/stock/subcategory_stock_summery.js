...
// @route GET /api/report/subcategory/stock/summery/report?branch=..........
// @description Get subcategory wise summery stock report pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var options = {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        class="table-border">
                        <tr>
                            <th style="font-size: 8px; text-align: left; width: 18%">SubCategory Code</th>
                            <th style="font-size: 8px; text-align: left; width: 42%">SubCategory Name</th>
            ...
            var document = {
                ...
                path: "./public/reports/subcategory_stock_report_summery.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/subcategory_stock_report_summery.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
router.get('/subcategory/stock/summary/:adminID/:subcategory', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Stock Summary Report By SubCategory At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Stock Summary Report By SubCategory At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('subcategory_wise_stock_summary.xlsx'); // This is sails.js specific (in general you need to set headers)
