...
// @route GET /api/report/supplier/stock/summery/report?branch=..........
// @description Get supplier wise summery stock report pdf
// @access Private
router.post('/supplier/stock/report', [
    ...
    try {
        ...
        const child = fork(path.join(__dirname, "subprocess", "supplier_stock_summery.js"));
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "summery stock report by supplier",
            ...
            var options = {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        class="table-border">
                        <tr>
                            <th style="font-size: 8px; text-align: left; width: 14%">Supplier Code</th>
                            <th style="font-size: 8px; text-align: left; width: 48%">Supplier Name</th>
...
// @route GET /api/report/supplier/stock/summary/:adminID/:supplier?branch=..........
// @description Get supplier wise summary stock report excel
// @access Private
router.get('/supplier/stock/summary/:adminID/:supplier', async (req, res) => {
    try {
        const error = validationResult(req)
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Stock Summary Report By Supplier At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Stock Summary Report By Supplier At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('supplier_wise_stock_summary.xlsx'); // This is sails.js specific (in general you need to set headers)
