    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_statement_of_finantial_position.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_statement_of_finantial_position.pdf',
                        filename: 'warehouse_statement_of_finantial_position'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /accounts/finantial_position_statement/details/excel?from=?&to=?
// description Get Warehouse finantial position statement details Excel report
// @access Private
router.get('/accounts/finantial_position_statement/:adminID/:from/:to', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Finantial Position Statement date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Finantial Position Statement date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_finantial_position_statement_date_wise.xlsx'); // This is sails.js specific (in general you need to set headers)
