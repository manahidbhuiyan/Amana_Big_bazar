...
router.post('/accounts/ledger/details', adminAuth, async (req, res) => {
    try {
        ...
        let {from, to, group, subgroup, category, subcategory, supplier} = req.body
        let type = 'pdf'
        let condition = {}
        ...
        child.on('message', async (response) => {
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_ledger_report_details_date_wise.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_ledger_report_details_date_wise.pdf',
                        filename: 'warehouse_ledger_report_details_date_wise'
                    })
                })
                .catch(error => {
                    console.error(error)
