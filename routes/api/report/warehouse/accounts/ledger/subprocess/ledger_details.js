...
process.on('message', async (msg) => {
    ...
    }).select('create name warehouse_opening_balance')
    ...
    if(condition.supplier == undefined){ 
        closingBalance += (subcategoryInfo.warehouse_opening_balance ? subcategoryInfo.warehouse_opening_balance : 0)
    }else{
        closingBalance += (supplierInfo.warehouseOpeningBalance ? supplierInfo.warehouseOpeningBalance : 0)
    }
