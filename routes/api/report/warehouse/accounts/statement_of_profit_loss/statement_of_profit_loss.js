    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_statement_of_profit_loss.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_statement_of_profit_loss.pdf',
                        filename: 'warehouse_statement_of_profit_loss'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /accounts/statement_profit_loss/excel?from=?&to=?
// description Get Warehouse statement profit loss  Excel report
// @access Private
router.get('/accounts/statement_profit_loss/:adminID/:from/:to', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Statement of Profit/Loss date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Statement of Profit/Loss date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_statement_of_profit_loss_date_wise.xlsx'); // This is sails.js specific (in general you need to set headers)
