...
router.post('/single/product-wise/analysis', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var html = fs.readFileSync(path.join(__dirname, '..', '..', '..', '..','..', 'reports', 'warehouse', 'analysis', 'product_name_wise_sales_analysis.html'), 'utf8');
...
// @route GET api/report/single/product-wise/analysis/:adminID/:from/:to/:name
