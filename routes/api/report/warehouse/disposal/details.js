...
// @route GET api/report/disposal/details
// @description Get warehouse disposal report details pdf
// @access Private
router.post('/disposal/details', auth, async (req, res) => {
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var options = {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        class="">
                        <tr>
                            <th style="font-size: 10px; text-align: left; width: 24%;">Product Name</th>
                            <th style="font-size: 10px; text-align: left; width: 28%;">Supplier Name</th>
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_disposal_details_date_wise.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_disposal_details_date_wise.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET api/disposal/details?branch=..........
// description Get disposal details Excel report
// @access Private
router.get('/disposal/details/:adminID/:from/:to', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Disposal report date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Disposal report date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_disposal_report_date_wise.xlsx'); // This is sails.js specific (in general you need to set headers)
