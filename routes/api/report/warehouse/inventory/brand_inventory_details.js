...
// @route GET api/report/brand/inventory/details/report
// @description Get brand inventory report details pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "detail warehouse inventory report by brand",
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_brand_inventory_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_brand_inventory_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET api/report/brand/inventory/details/report/:adminID/:brand
// @description Get brand inventory report details excel
// @access Private
router.get('/brand/inventory/details/report/:adminID/:brand', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Brand wise warehouse Inventory Stock Details On Date : ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Brand wise warehouse Inventory Stock Details On Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('brand_wise_warehouse_inventory_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
