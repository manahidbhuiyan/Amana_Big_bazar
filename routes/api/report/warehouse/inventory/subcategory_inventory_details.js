...
// @route GET api/report/subcategory/inventory/details/report
// @description Get subcategory inventory report details pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "detail warehouse inventory report by subcategory",
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_subcategory_inventory_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_subcategory_inventory_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET api/report/subcategory/inventory/details/report/:adminID/:subcategory
// @description Get subcategory inventory report details excel
// @access Private
router.get('/subcategory/inventory/details/report/:adminID/:subcategory', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'SubCategory wise warehouse Inventory Stock Details On Date : ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'SubCategory wise warehouse Inventory Stock Details On Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('subcategory_wise_warehouse_inventory_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
