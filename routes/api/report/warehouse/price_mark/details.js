...
// @route GET api/report/price-mark/details
// @description Get warehouse price mark report details pdf
// @access Private
router.post('/price-mark/details', auth, async (req, res) => {
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_price_mark_change_date_wise.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_price_mark_change_date_wise.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /api/report/warehouse/price-mark/details?branch=..........
// @description Get warehouse price mark details Excel report
// @access Private
router.get('/price-mark/details/:adminID/:from/:to', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Price mark change date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Price mark change date wise from: ' + reportFullDataset.fromDate + ' To: ' + reportFullDataset.toDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_price_mark_change_date_wise.xlsx'); // This is sails.js specific (in general you need to set headers)
