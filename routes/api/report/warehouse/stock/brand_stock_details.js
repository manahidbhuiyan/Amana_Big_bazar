...
// @route GET api/report/brand/stock/details/report
// @description Get all brands stock report details pdf
// @access Private
router.post('/brand/stock/details/report', [
    adminAuth,
    [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "detail stock report by brand",
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_brand_stock_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_brand_stock_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
router.get('/brand/stock/details/:adminID/:brand/:zero_stock', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Stock Details Report By Brand At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Stock Details Report By Brand At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_brand_wise_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
