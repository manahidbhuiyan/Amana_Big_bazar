...
// @route GET api/report/brand/stock/summery/report
// @description Get all brands stock report summery pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var options = {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        class="table-border">
                        <tr>
                            <th style="font-size: 10px; text-align: left; width: 18% ;padding-left: 3px">Brand Code</th>
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_brand_stock_report_summery.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_brand_stock_report_summery.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
router.get('/brand/stock/summary/:adminID/:brand', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Stock Summary Report By Brand At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Stock Summary Report By Brand At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_brand_wise_stock_summary.xlsx'); // This is sails.js specific (in general you need to set headers)
