...
// @route GET api/report/subcategory/stock/details/report
// @description Get subategories stock report details pdf
// @access Private
router.post('/subcategory/stock/details/report', [
    adminAuth,
    [
    ...
    try {
        ...
        let { subcategory, zero_stock } = req.body
        ...
        const child = fork(path.join(__dirname, "subprocess", "subcategory_stock_details.js"));
        ...
        child.on('message', async (response) => {
            ...
            let reportFullDataset = {
                title: "detail stock report by subcategory",
            ...
            var options = {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        class="table-border">
                        <tr>
                            <th style="font-size: 10px; text-align: left; width: 11% ;padding-left: 3px">Barcode</th>
                            <th style="font-size: 10px; text-align: left; width: 18%">Product Name</th>
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_subcategory_stock_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_subcategory_stock_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
// @route GET /api/report/subcategory/stock/details/:adminID/:subcategory/:zero_stock?branch=..........
// @description Get subcategory wise details stock report excel
// @access Private
router.get('/subcategory/stock/details/:adminID/:subcategory/:zero_stock', async (req, res) => {
    try {
        const error = validationResult(req)
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Stock Details Report By SubCategory At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Stock Details Report By SubCategory At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_subcategory_wise_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
