...
// @route GET api/report/supplier/stock/details/report
// @description Get supplier stock report details pdf
// @access Private
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var document = {
                ...
                path: "./public/reports/warehouse_supplier_stock_report_details.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_supplier_stock_report_details.pdf'
                    })
                })
                .catch(error => {
                    console.error(error)
...
router.get('/supplier/stock/details/:adminID/:supplier/:zero_stock', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Stock Details Report By Supplier At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Stock Details Report By Supplier At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_supplier_wise_stock_details.xlsx'); // This is sails.js specific (in general you need to set headers)
