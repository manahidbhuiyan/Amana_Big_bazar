...
// @route GET api/report/supplier/stock/report
// @description Get supplier stock report summery pdf
// @access Private
            ...
            var options = {
                ...
                header: {
                    ...
                    contents: {
                        ...
                        class="table-border">
                        <tr>
                            <th style="font-size: 10px; text-align: left; width: 18% ;padding-left: 3px">Supplier Code</th>
...
router.get('/supplier/stock/summary/:adminID/:supplier', async (req, res) => {
    try {
        ...
        child.on('message', async (response) => {
            ...
            const heading = [
                [{ value: 'Warehouse Stock Summary Report By Supplier At Date: ' + reportFullDataset.currentDate, style: styles.headerDark }],
            ...
            const report = excel.buildExport(
                [ // <- Notice that this is an array. Pass multiple sheets to create multi sheet report
                    {
                        name: 'Warehouse Stock Summary Report By Supplier At Date: ' + reportFullDataset.currentDate, // <- Specify sheet name (optional)
                        heading: heading,
                        merges: merges,
            ...
            res.attachment('warehouse_supplier_wise_stock_summary.xlsx'); // This is sails.js specific (in general you need to set headers)
