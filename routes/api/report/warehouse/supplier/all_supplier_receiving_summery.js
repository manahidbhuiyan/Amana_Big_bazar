...
// @route GET api/report/warehouse/all/supplier-receiving/summery
// @description Get warehouse all suppliers receiving summery pdf
// @access Private
router.post('/all/supplier-receiving/summery', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var html = fs.readFileSync(path.join(__dirname, '..', '..', '..', '..', '..', 'reports', 'warehouse', 'summery', 'all_supplier_receiving_summery.html'), 'utf8');
                    ...
                    contents: {
                        ...
                        class="table-border">
                            <tr>
                                ...
                                <th style="font-size: 10px; text-align: left; width: 15%">Receiving No</th>
            ...
            var document = {
                html: html,
                data: allDataInfo,
                path: "./public/reports/warehouse_all_supplier_receiving_summery.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_all_supplier_receiving_summery.pdf'
                    })
                    //res.download(file);
                })
                .catch(error => {
...
// @route GET api/report/warehouse/all/supplier-receiving/summery/:adminID/:from/:to?branch=..........
// @description Get all warehouse supplier receiving summery excel
// @access Private
router.get('/all/supplier-receiving/summery/:adminID/:from/:to', [
    [
        check('from', 'From date is required').not().isEmpty(),
        check('to', 'To date is required').not().isEmpty(),
    ]
