...
// @route GET api/report/warehouse/single/supplier-receiving/summery
// @description Get warehouse single supplier receiving report summery pdf
// @access Private
router.post('/single/supplier-receiving/summery', [
    ...
    try {
        ...
        child.on('message', async (response) => {
            ...
            var html = fs.readFileSync(path.join(__dirname, '..', '..', '..', '..', '..', 'reports', 'warehouse', 'summery', 'single_supplier_receiving_summery.html'), 'utf8');
                    ...
                    contents: {
                        ...
                        class="table-border">
                            <tr>
                                ...
                                <th style="font-size: 10px; text-align: left; width: 33%">Receiving No</th>
            ...
            var document = {
                html: html,
                data: allDataInfo,
                path: "./public/reports/warehouse_single_supplier_receiving_summery.pdf"
            };
            ...
            pdf.create(document, options)
                .then(data => {
                    ...
                    return res.status(200).json({
                        auth: true,
                        fileLink: '/reports/warehouse_single_supplier_receiving_summery.pdf'
                    })
                    //res.download(file);
                })
                .catch(error => {
...
// @route GET api/report/warehouse/single/supplier-receiving/summery/:adminID/:from/:to/:supplier?branch=..........
// @description Get warehouse single supplier receiving report summery excel 
// @access Private
router.get('/single/supplier-receiving/summery/:adminID/:from/:to/:supplier', [
    [
        check('from', 'From date is required').not().isEmpty(),
        check('to', 'To date is required').not().isEmpty(),
    ]
