...
router.post('/print', [
    ...
    try {
        ...
        let productDiscount = await ProductDiscount.findById(download_id).populate('admin', 'name').populate('branch', 'name address serialNo phone')
        ...
        allDataInfo.branchPhone = productDiscount.branch.phone
        allDataInfo.branchId = productDiscount.branch.serialNo
