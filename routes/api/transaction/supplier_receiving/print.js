...
router.post('/print', [
    ...
    try {
        ...
        let supplierRecevingData = await ReceiveFromSupplier.findById(download_id).populate('supplier', '_id name contact').populate('admin', 'name').populate('branch', 'name address phone serialNo')
        ...
        allDataInfo.branchName = supplierRecevingData.branch.name
        allDataInfo.branchAddress = supplierRecevingData.branch.address
        ...
        allDataInfo.branch_phone = supplierRecevingData.branch.phone
        allDataInfo.branch_serial = supplierRecevingData.branch.serialNo
