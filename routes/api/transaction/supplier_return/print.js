...
router.post('/print', [
    ...
    try {
        ...
        let supplierReturnData = await ReturnToSupplier.findById(download_id).populate('supplier', '_id name contact').populate('admin', 'name').populate('branch', 'name address phone serialNo')
        ...
        allDataInfo.branchName = supplierReturnData.branch.name
        allDataInfo.branchAddress = supplierReturnData.branch.address
        ...
        allDataInfo.branch_phone = supplierReturnData.branch.phone
        allDataInfo.branch_serial = supplierReturnData.branch.serialNo
