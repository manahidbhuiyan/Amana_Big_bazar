...
//         let productDisposalData = await ProductReconciliation.find(condition).populate('admin', '_id name').sort({create:'desc'}).limit(dataList).skip(offset)
...
//                 totalBill += (disposeProduct.price.purchase*disposeProduct.reconciliation)
//             })
