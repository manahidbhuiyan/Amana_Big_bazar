...
router.post('/return/print', [
    ...
    try {
        ...
        allDataInfo.requisitionNo = supplierRequisitionData.returnNo
        ...
        var html = fs.readFileSync(path.join(__dirname, '..', '..', '..', '..', 'reports', 'supply', 'return_from_branch.html'), 'utf8');
