...
router.post('/print', [
    ...
    try {
        ...
        let productDisposal = await ProductDisposal.findById(download_id).populate('admin', 'name')
        ...
        productDisposal.products.map((productInfo, index)=>{
            ...
            allProducts.push({
                ...
                stock: productInfo.stock - productInfo.disposal,
                disposal: productInfo.disposal,
        ...
        var document = {
            html: html,
            data: allDataInfo,
            path: "./public/reports/warehouse_disposal_report.pdf"
        };
        ...
        pdf.create(document, options)
            .then(data => {
                ...
                return res.status(200).json({
                    auth: true,
                    fileLink: '/reports/warehouse_disposal_report.pdf' 
                })
            })
            .catch(error => {
                console.error(error)
