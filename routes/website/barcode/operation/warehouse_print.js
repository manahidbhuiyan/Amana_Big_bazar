...
/* GET login page. */
router.get('/barcode-print', urlAuth('warehouse product barcode print'), function(req, res, next) {
  const scripts = [
  ...
  const data = {
    ...
    pageTitle: "Manage Warehouse Product Barcode Print",
    adminInfo: req.adminInfo,
  }

  res.render('pages/barcode/warehouse_print', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
...
router.get('/', function(req, res, next) {
  res.redirect('/dashboard/warehouse/product/list')
});
