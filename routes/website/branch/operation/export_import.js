...
/* GET Branch Export Import page. */
router.get('/export-import', urlAuth('export import branch'), function(req, res, next) {
  const scripts = [
  ...
  const breadcumb = {
    ...
    sub: [
      {
        text: 'export import',
        link: config.get('hostname') + '/dashboard/branch/export-import'
      }
    ]
  }
