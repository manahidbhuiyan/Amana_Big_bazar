...
/* GET login page. */
router.get('/pos-client', urlAuth('export import pos client'), function (req, res, next) {
  const scripts = [
  ...
  const breadcumb = {
    ...
    sub: [{
      text: 'pos client',
      link: config.get('hostname') + '/dashboard/export-import/pos-client'
    }]
  }
  ...
  res.render('pages/pos_order/client_export_import', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
