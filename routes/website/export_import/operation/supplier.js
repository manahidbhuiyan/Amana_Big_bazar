...
/* GET login page. */
router.get('/supplier', urlAuth('export import supplier'), function (req, res, next) {
  const scripts = [
  ...
  const breadcumb = {
    ...
    sub: [{
      text: 'supplier',
      link: config.get('hostname') + '/dashboard/export-import/supplier'
    }]
  }
  ...
  res.render('pages/supplier/export_import', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
