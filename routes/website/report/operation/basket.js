...
/* GET login page. */
router.get('/basket', urlAuth('report basket'), function (req, res, next) {
  const scripts = [
  ...
  const breadcumb = {
    ...
    sub: [
      {
        text: 'basket',
        link: config.get('hostname') + '/dashboard/report/basket'
      }
    ]
  }
  ...
  const data = {
    ...
    pageTitle: "Comparative Basket Report",
    adminInfo: req.adminInfo,
  }

  res.render('pages/report/basket', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
