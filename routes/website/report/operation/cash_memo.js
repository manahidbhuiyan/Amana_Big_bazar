...
/* GET login page. */
router.get('/cash-memo', urlAuth('report cash memo'), function(req, res, next) {
  const scripts = [
  ...
  const breadcumb = {
    ...
    sub: [
      {
        text: 'cash memo',
        link: config.get('hostname') + '/dashboard/report/cash-memo'
      }
    ]
  }
  ...
  const data = {
    ...
    pageTitle: "Cash Memo Report",
    adminInfo: req.adminInfo,
  }

  res.render('pages/report/cash_memo', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
