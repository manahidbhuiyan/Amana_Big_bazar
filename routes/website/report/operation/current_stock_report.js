...
/* GET login page. */
router.get('/current-stock-report', urlAuth('report current stock report'), function(req, res, next) {
  const scripts = [
    ...
    sub: [
      {
        ...
        link: config.get('hostname') + '/dashboard/report/stock-report'
      }
    ]
  }
  ...
  res.render('pages/report/current_stock_report', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
