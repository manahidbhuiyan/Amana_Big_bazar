...
/* GET login page. */
router.get('/daily-stock-report', urlAuth('report daily stock report'), function(req, res, next) {
  const scripts = [
  ...
  const data = {
    ...
    pageTitle: "Daily Stock Report",
    adminInfo: req.adminInfo,
  }

  res.render('pages/report/daily_stock_report', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
