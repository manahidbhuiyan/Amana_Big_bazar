...
/* GET login page. */
router.get('/disposal', urlAuth('report disposal report'), function(req, res, next) {
  const scripts = [
  ...
  const breadcumb = {
    ...
    sub: [
      {
        text: 'disposal',
        link: config.get('hostname') + '/dashboard/report/disposal'
      }
    ]
  }
  ...
  const data = {
    ...
    pageTitle: "Disposal Report",
    adminInfo: req.adminInfo,
  }

  res.render('pages/report/disposal', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
