...
/* GET Vat Report Page */
router.get('/vat-report', urlAuth('report vat report'), function(req, res, next) {
  const scripts = [
  ...
  const breadcumb = {
    ...
    sub: [
      {
        text: 'vat report',
        link: config.get('hostname') + '/dashboard/report/vat-report'
      }
    ]
  }
  ...
  res.render('pages/report/vat_report', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
