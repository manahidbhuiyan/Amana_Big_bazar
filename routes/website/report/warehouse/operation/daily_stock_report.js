...
/* GET login page. */
router.get('/daily-stock-report', urlAuth('warehouse report daily stock'), function(req, res, next) {
  const scripts = [
    ...
    sub: [
      {
        ...
        link: config.get('hostname') + '/dashboard/report/warehouse/daily-stock-report'
      }
    ]
  }
  ...
  const data = {
    ...
    pageTitle: "Warehouse Daily Stock Report",
    adminInfo: req.adminInfo,
  }

  res.render('pages/report/warehouse/daily_stock_report', {
    scripts: scripts,
    styles: styles,
    breadcumb: breadcumb,
    data: data,
