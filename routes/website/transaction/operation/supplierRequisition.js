...
/* GET Branch Transaction Requisition */
router.get('/supplier-requisition', urlAuth('transaction supplier requisition'), function (req, res, next) {
  const scripts = [
  ...
  const data = {
    ...
    pageTitle: "Requisition To Supplier",
    adminInfo: req.adminInfo,
  }

  res.render('pages/transaction/supplierRequisition', {
    scripts: scripts,
