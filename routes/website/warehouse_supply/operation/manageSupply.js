...
/* GET login page. */
router.get('/manage', urlAuth('supply to branch'), function (req, res, next) {
  const scripts = [
  ...
  const data = {
    siteTitle: config.get('company').name + " - Manage Warehouse Supply",
    pageTitle: "Manage Warehouse Supply",
    adminInfo: req.adminInfo,
  }

  res.render('pages/warehouse_supply/manage_supply', {
    scripts: scripts,
