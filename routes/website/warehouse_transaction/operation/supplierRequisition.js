...
/* GET Warehouse Transaction Requisition Page. */
router.get('/supplier-requisition', urlAuth('warehouse transaction supplier requisition'), function (req, res, next) {
  const scripts = [
  ...
  const data = {
    ...
    pageTitle: "Requisition To Warehouse Supplier",
    adminInfo: req.adminInfo,
  }

  res.render('pages/warehouse_transaction/supplierRequisition', {
    scripts: scripts,
